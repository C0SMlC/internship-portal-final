                ...
                <tr class="table-light">
                    ...
                    <td class="py-3 text-center ">
                        <div class="d-flex justify-content-center align-items-center">
                            ...
                            <a href="../Internship/index1.php?id=<?php echo $announcement_id; ?>" class="btn btn-primary" role="button">
                    ...
                    <td class="py-3 text-center ">
                        <div class="d-flex justify-content-center align-items-center">
                            ...
                            <a href="../../Libraries/excel/process.php?id=<?php echo $announcement_id; ?>" class="btn btn-primary" role="button">
